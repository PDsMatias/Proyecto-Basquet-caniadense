...
function encontrarPersona(personaEnBusqueda) {
  ...
  function proyeccionPorPersona(nombrePersona) {
    ...
    const personaEncontrada = encontrarPersona(nombrePersona);
    const trabajos = personaEncontrada.trabajos
...
// function encontrarPersona(personaEnBusqueda){
//    salarios.find((persona)=> persona.name == personaEnBusqueda)
// }
...
//    const medianaCalculadaDePorcentajes = Matimath.mediana(porcentajesCrecimiento)
//    const salarioUltimoAño = trabajos[trabajos.length - 1].salario
//    return salarioUltimoAño * medianaCalculadaDePorcentajes
// }